...
class login_form(forms.Form):
    dni = forms.CharField(label="", max_length=8, widget=forms.TextInput(attrs={'placeholder': 'Ingresa tu DNI', 'data-lpignore': 'true'}))
...
class register_form(forms.Form):
    dni = forms.CharField(label="", max_length=8, widget=forms.TextInput(attrs={'placeholder': 'Ingresa tu DNI', 'autocomplete': 'off'}))
    name = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'placeholder': 'Ingresa tus nombres', 'autocomplete': 'off'}))
